...
class Wallet extends React.Component {
    ...
    // TODO-9: charge money
    handleChargeMoney = () => {
        this.props.handleAdjustMoney(parseInt(this.state.chargeMoney));
        this.setState(
            {chargeMoney: ''}
        )
    }
                    ...
                    <Grid container justifyContent="space-around">
                        ...
                        <Grid item container xs={5}>
                            ...
                            <TextField
                                ...
                                fullWidth
                                onChange={(event) => {
                                    this.setState({chargeMoney: event.target.value});
                                }}
                        ...
                        <Grid item container xs={2}>
                            ...
                            <IconButton className={classes.chargeButton} onClick={this.handleChargeMoney}>
