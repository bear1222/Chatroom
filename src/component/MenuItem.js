...
class MenuItem extends React.Component {
    ...
    render() {
        const { classes, item, price, amount, click } = this.props;
        ...
        return (
            <div>
                ...
                <Grid container direction="row" justifyContent="space-evenly">
                    ...
                    <IconButton color="primary" onClick={() => click(item, Math.max(0, amount - 1))}>
                        <RemoveCircleIcon className={classes.icon} />
                    </IconButton>
                    <span className={classes.amount}>{amount}</span>
                    <IconButton color="primary" onClick={() => click(item, amount + 1)}>
